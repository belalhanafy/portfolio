    ...
    (<motion.div
      ...
      <div className="inset-0 flex-none w-full h-full -mt-7">
        ...
        <div
          ...
          className="absolute left-1/2 top-32 ml-[0.09375rem] mt-4 -translate-x-1/2 -translate-y-1/2">
          <>
            <motion.div
              initial={{
                opacity: 0,
        ...
        <>
          <motion.div
            className="absolute right-1/2 -top-8 bg-gradient-to-b from-transparent to-cyan-500 translate-y-[14px] w-px h-20 group-hover/pin:h-40 blur-[2px]" />
          <motion.div
            className="absolute right-1/2 -top-8 bg-gradient-to-b from-transparent to-cyan-500 translate-y-[14px] w-px h-20 group-hover/pin:h-40  " />
          <motion.div
            className="absolute right-1/2 translate-x-[1.4px] top-[7.8rem] bg-cyan-600 translate-y-[14px] w-[4px] h-[4px] rounded-full z-40 blur-[3px]" />
          <motion.div
            className="absolute right-1/2 translate-x-[1.4px] top-[7.8rem] bg-cyan-300 translate-y-[14px] w-[4px] h-[4px] rounded-full z-40 " />
        </>
      </div>
    </motion.div>)
  );
