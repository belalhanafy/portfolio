    ...
    return (
        <>
            <div className="h-[40rem] w-full flex items-center justify-center ">
                ...
                >
                    <>
                        <div className="relative md:h-[20rem] sm:h-[15rem] h-[10rem] w-full flex items-center justify-center">
                            <img
                                src={img}
                                alt="projectPhoto"
                        ...
                        <div className='flex flex-col justify-between h-auto'>
                            <div className='flex-grow-1'>
                                <div className="py-2 text-lg font-bold text-black sm:text-2xl dark:text-white">{title}</div>
                                <div className="py-1 text-base text-black sm:text-xl dark:text-white text-white-100">{des}</div>
                            </div>
                            <div className="flex flex-col items-start justify-between gap-2 mt-10 md:items-center sm:gap-0 md:mt-20 sm:flex-row">
